...
<html lang="en" dir="ltr">
    ...
    <style>
    .gmap {background-color:  #DD4B3E;} /* Blue */
    .gmap:hover {background: #822F2B;}
    ...
    <div class="address">
        ...
        <address>
              ...
              <i class="fa fa-envelope"></i>:
                <a href="mailto:confusion@food.net">paradise@travels.net</a>
           </address>
    </div>
    <div class="buttons">
        <div class="btn-group" role="group">
            ...
            <a role="button" class="btn email" href="mailto:confusion@food.net"><i class="fa fa-envelope-o"></i> Email</a>
        </div>
    </div>
</div>
